...
Bridge.assembly("Bridge.Test.Bridge.ClientTest.Batch3", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner", {
        main: function Main () {
            ...
            QUnit.test("#2981 - TestCharIsPunctuation", Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2981.TestCharIsPunctuation);
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2981", {
        inherits: [Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2981)],
        statics: {
            methods: {
                TestCharIsPunctuation: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2981).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2981, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestCharIsPunctuation()", $t.Line = "15", $t));
                    Bridge.ClientTest.Batch3.BridgeIssues.Bridge2981.TestCharIsPunctuation();
                }
            }
        },
        fields: {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t = new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge2981", $t.File = "Batch3\\BridgeIssues\\2900\\N2981.cs", $t);
                }
                return this.context;
            }
        }
