        ...
        statics: {
            methods: {
                TestBaseProperty: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge3088).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge3088, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestBaseProperty()", $t.Line = "21", $t));
