    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2176", {
        ...
        statics: {
            TestExternalObjectLiteralConstructorMode: function (assert) {
                var $t;
                var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2176).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2176, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestExternalObjectLiteralConstructorMode()", $t.Line = "36", $t));
