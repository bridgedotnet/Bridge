        ...
        statics: {
            methods: {
                TestRoundtripFormat: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2657).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2657, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestRoundtripFormat()", $t.Line = "13", $t));
