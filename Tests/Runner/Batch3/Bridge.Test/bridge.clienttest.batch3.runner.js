...
Bridge.assembly("Bridge.Test.Bridge.ClientTest.Batch3", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner", {
        main: function Main () {
            ...
            QUnit.test("#3031 - TestLongParse", Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge3031.TestLongParse);
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge3031", {
        inherits: [Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge3031)],
        statics: {
            methods: {
                TestLongParse: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge3031).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge3031, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestLongParse()", $t.Line = "15", $t));
                    Bridge.ClientTest.Batch3.BridgeIssues.Bridge3031.TestLongParse();
                }
            }
        },
        fields: {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t = new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge3031", $t.File = "Batch3\\BridgeIssues\\3000\\N3031.cs", $t);
                }
                return this.context;
            }
        }
