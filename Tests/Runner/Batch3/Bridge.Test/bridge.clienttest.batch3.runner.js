        ...
        statics: {
            methods: {
                TestStackTrace: function (assert) {
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2592).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2592, void 0, Bridge.merge(new Bridge.Test.Runtime.TestContext(), {
                        Method: "TestStackTrace()",
                        Line: "31"
                    } ));
        ...
        methods: {
            GetContext: function () {
                if (this.context == null) {
                    this.context = Bridge.merge(new Bridge.Test.Runtime.FixtureContext(), {
                        Project: "Batch3",
                        ClassName: "Bridge.ClientTest.Batch3.BridgeIssues.Bridge2592",
                        File: "Batch3\\BridgeIssues\\2500\\N2592.cs"
                    } );
                }
                return this.context;
            }
