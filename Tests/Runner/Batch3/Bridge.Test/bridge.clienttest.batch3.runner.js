    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1134", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge1134", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/1100/N1134.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1241", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge1241", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/1200/N1241.cs", $t);
                }
                return this.context;
            }
        }
        ...
        statics: {
            methods: {
                TestFieldInitializer: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1390).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1390, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestFieldInitializer()", $t.Line = "18", $t));
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1438", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge1438", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/1400/N1438.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2610", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge2610", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/2500/N2610.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge501", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge501", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/0500/N501.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge544", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge544", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch3/BridgeIssues/0500/N544.cs", $t);
                }
                return this.context;
            }
        }
