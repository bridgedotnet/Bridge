        ...
        statics: {
            methods: {
                TestContainsFunction: function (assert) {
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2571).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2571, void 0, Bridge.merge(new Bridge.Test.Runtime.TestContext(), {
                        Method: "TestContainsFunction()",
                        Line: "11"
                    } ));
        ...
        methods: {
            GetContext: function () {
                if (this.context == null) {
                    this.context = Bridge.merge(new Bridge.Test.Runtime.FixtureContext(), {
                        Project: "Batch3",
                        ClassName: "Bridge.ClientTest.Batch3.BridgeIssues.Bridge2571",
                        File: "Batch3\\BridgeIssues\\2500\\N2571.cs"
                    } );
                }
                return this.context;
            }
