    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2759", {
        ...
        statics: {
            methods: {
                TestOrder: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2759).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2759, 1, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestOrder()", $t.Line = "30", $t));
