...
Bridge.assembly("Bridge.Test.Bridge.ClientTest.Batch3", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner", {
        main: function Main () {
            ...
            QUnit.test("#2935 - TestEnumBaseType", Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2935.TestEnumBaseType);
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2935", {
        ...
        statics: {
            methods: {
                TestEnumBaseType: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2935).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2935, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestEnumBaseType()", $t.Line = "11", $t));
                    Bridge.ClientTest.Batch3.BridgeIssues.Bridge2935.TestEnumBaseType();
                }
            }
        },
        fields: {
