        ...
        statics: {
            methods: {
                TestNonStandardName: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge3081).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge3081, void 0, ($t = new Bridge.Test.Runtime.TestContext(), $t.Method = "TestNonStandardName()", $t.Line = "30", $t));
