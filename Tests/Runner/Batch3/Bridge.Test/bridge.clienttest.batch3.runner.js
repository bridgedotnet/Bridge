        ...
        statics: {
            methods: {
                TestEntryPointCustomName: function (assert) {
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2591).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2591, void 0, Bridge.merge(new Bridge.Test.Runtime.TestContext(), {
                        Method: "TestEntryPointCustomName()",
                        Line: "17"
                    } ));
        ...
        methods: {
            GetContext: function () {
                if (this.context == null) {
                    this.context = Bridge.merge(new Bridge.Test.Runtime.FixtureContext(), {
                        Project: "Batch3",
                        ClassName: "Bridge.ClientTest.Batch3.BridgeIssues.Bridge2591",
                        File: "Batch3\\BridgeIssues\\2500\\N2591.cs"
                    } );
                }
                return this.context;
            }
