...
Bridge.$N1391Result =                 r;
    ...
    Bridge.define("Bridge.ClientTest.Batch3.BridgeIssues.Bridge1900", {
        ...
        testOutParamInMetadata: function () {
            ...
            Bridge.Test.Assert.true(Bridge.referenceEquals((Bridge.Reflection.getMembers(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1900, 8, 284, "GetValue").params || [])[0], Object));
        }
    });
