...
Bridge.initAssembly("Bridge.ClientTest.Batch3", function ($asm, globals) {
    ...
    Bridge.define('Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529', {
        testObjectLiteral: function () {
            var bs = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.ctor();
            ...
            var bs2 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.$ctor1(5);
            ...
            var bs3 = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.$ctor2("test5");
            ...
            var ds1 = Bridge.merge(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.DS.ctor(), {
                field: 9
            } );
            ...
            var ts = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.TS.ctor();
    ...
    Bridge.define('Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS', {
        ...
        statics: {
            ...
            create: function (i, s) {
                return Bridge.merge(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.ctor(), {
                    field1: i, field2: s
                } );
            }
        },
        ...
        $ctor1: function (i) {
            var $this = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.ctor();
            (function(){
                this.field1 = i;
            }).call($this);
            return $this;
    ...
    Bridge.define('Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.TS', {
        ...
        $literal: true,
        ctor: function () {
            var $this = Bridge.ClientTest.Batch3.BridgeIssues.Bridge1529.BS.$ctor1(8);
            (function(){
