...
Bridge.assembly("Bridge.ClientTest.Batch3", function ($asm, globals) {
    ...
    Bridge.define("Bridge.ClientTest.Batch3.BridgeIssues.Bridge1900", {
        ...
        testOutParamInMetadata: function () {
            Bridge.Test.Assert.true(Bridge.referenceEquals((Bridge.Reflection.getMembers(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1900, 8, 284, "TryGetValue").params || [])[0], System.Int32));
        }
    });
    ...
    Bridge.setMetadata(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1900, function () { return {"members":[{"accessibility":1,"name":"TryGetValue","isStatic":true,"type":8,"paramsInfo":[{"name":"value","isOut":true,"parameterType":System.Int32,"position":0}],"sname":"tryGetValue","returnType":Boolean,"params":[System.Int32]}]}; });
