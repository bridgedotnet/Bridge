Bridge.assembly("Bridge_ClientTest_Batch3_Tests", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner", {
        $main: function () {
            ...
            QUnit.test("#2181 - TestStringPad", Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge2181.testStringPad);
        ...
        statics: {
            testStringPad: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2181).beforeTest(false, assert, Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge2181, void 0, Bridge.merge(new Bridge.Test.QUnit.TestContext(), {
                    method: "TestStringPad()",
                    line: "11"
                } ));
                Bridge.ClientTest.Batch3.BridgeIssues.Bridge2181.testStringPad();
            }
        },
        context: null,
        getContext: function () {
