Bridge.assembly("Bridge_ClientTest_Batch3_Tests", function ($asm, globals) {
    ...
    Bridge.define("Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner", {
        $main: function () {
            ...
            QUnit.test("#2280 - TestGetTypeInIgnoreGenericMethod", Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge2280.testGetTypeInIgnoreGenericMethod);
    ...
    Bridge.define("Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge2280", {
        inherits: [Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2280)],
        statics: {
            testGetTypeInIgnoreGenericMethod: function (assert) {
                var t = Bridge.Test.QUnit.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2280).beforeTest(false, assert, Bridge.Test.QUnit.Bridge_ClientTest_Batch3_Tests_Runner.Bridge_ClientTest_Batch3_BridgeIssues_Bridge2280, void 0, Bridge.merge(new Bridge.Test.QUnit.TestContext(), {
