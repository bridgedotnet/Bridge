        ...
        methods: {
            GetContext: function () {
                ...
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.Bridge1385", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/BridgeIssues/N1385.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.Bridge1499", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.Bridge1499", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/BridgeIssues/N1499.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.CheckedInsideUncheckedTests", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.CheckedUncheckedTests.CheckedInsideUncheckedTests", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/CheckedUncheckedTests.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.CheckedTests", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.CheckedUncheckedTests.CheckedTests", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/CheckedUncheckedTests.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.N1122", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.N1122", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/BridgeIssues/N1122.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.N1204", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.N1204", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/BridgeIssues/N1204.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.N772", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.N772", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/BridgeIssues/N772.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.UncheckedInsideCheckedTests", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.CheckedUncheckedTests.UncheckedInsideCheckedTests", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/CheckedUncheckedTests.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.UncheckedTests", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.CheckedUncheckedTests.UncheckedTests", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/CheckedUncheckedTests.cs", $t);
                }
                return this.context;
            }
        }
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.WithNoUncheckedKeywordTests", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.CheckedUncheckedTests.WithNoUncheckedKeywordTests", $t.File = "file:///C:/NET/BridgeNew/Bridge/Tests/Batch2/CheckedUncheckedTests.cs", $t);
                }
                return this.context;
            }
        }
