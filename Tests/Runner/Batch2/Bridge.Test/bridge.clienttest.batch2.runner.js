    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch2Runner.N3075", {
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t = new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch2", $t.ClassName = "Bridge.ClientTest.Batch2.BridgeIssues.N3075", $t.File = "file:///C:/projects/Bridge/v1/Bridge/Tests/Batch2/BridgeIssues/N3075.cs", $t);
                }
                return this.context;
            }
        }
