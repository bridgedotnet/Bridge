...
namespace Bridge.ClientTest.ConvertTests
{
    ...
    public class ConvertToUInt64Tests : ConvertTestBase<ulong>
    {
        ...
        public void FromString()
        {
            ...
            string[] testValues = { "1000", "0", ushortMaxValue.ToString(), uintMaxValue.ToString(), null, "0000000000000010" };
            ulong[] expectedValues = { 1000, 0, ushort.MaxValue, uint.MaxValue, 0, 10 };
        ...
        public void FromStringWithBase()
        {
            ...
            string[] testValues = { null, null, null, null, ConvertConstants.UINT64_MAX_STRING_BASE_16, maxSafeValue.ToString(), ConvertConstants.UINT64_MAX_STRING_BASE_8, ConvertConstants.UINT64_MAX_STRING_BASE_2, "0000000000000010" };
            int[] testBases = { 10, 2, 8, 16, 16, 10, 8, 2, 16 };
            ulong[] expectedValues = { 0, 0, 0, 0, maxSafeValue, maxSafeValue, maxSafeValue, maxSafeValue, 16 };
