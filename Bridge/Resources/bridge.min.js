...
return str.match(suffix+"$")!==null;},contains:function(str,value){return str.indexOf(value)>-1;},isDigit:function(str){if(str.length>1){return false;}
return str>="0"&&str<="9";}};Bridge.String=string;})();
